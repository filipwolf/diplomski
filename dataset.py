...
class YeastDataset(DGLDataset):
    ...
    def process(self):
        ...
        for i in range(0, 101):
            ...
            g.ndata.update({'node_out_degrees': node_out_degree_list_tensor,
                            'node_in_degrees': node_in_degree_list_tensor})
    ...
    def save(self):
        ...
        save_info(info_path, {'node_in_degrees': self.node_in_degrees,
